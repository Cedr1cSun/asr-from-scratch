...
from asrfs.sensevoice.dataset import build_collator, build_dataset
from asrfs.sensevoice.model import build_model, build_processor, save_checkpoint
...
def build_trainer(cfg, model, processor, train_ds, eval_ds, collator, overrides: dict):
    return build_ctc_trainer(
        ...
        default_run_name="sensevoice",
    )


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--config", type=str, default="asrfs/sensevoice/config.yaml")
